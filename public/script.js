// Particles is a function that recursive calls it self up-to partial-infinity.
// Adding a max limit to simulate partial-infinity in order to prevent max-depth-recursion.
// const MAX_ITERATIONS = 1000;
const MAX_ITERATIONS = 1;
function particles(i, result, id) {
  if(i === MAX_ITERATIONS) {
  ...
  render(result, id)
  i++;
  particles(i, result, id)
}

var colors = [[255,0,0],[255,4,0],[255,7,0],[255,11,0],[255,15,0],[255,18,0],[255,22,0],[255,25,0],[255,29,0],[255,33,0],[255,36,0],[255,40,0],[255,44,0],[255,47,0],[255,51,0],[255,55,0],[255,58,0],[255,62,0],[255,65,0],[255,69,18],[255,73,0],[255,76,0],[255,81,32],[255,84,0],[255,87,0],[255,91,0],[255,95,0],[255,98,0],[255,102,0],[255,105,0],[255,109,0],[255,113,0],[255,116,0],[255,120,0],[255,124,0],[255,127,0],[255,131,0],[255,135,0],[255,138,0],[255,142,0],[255,145,0],[255,149,18],[255,153,0],[255,156,0],[255,160,0],[255,164,0],[255,167,0],[255,171,0],[255,175,0],[255,178,0],[255,182,0],[255,185,0],[255,189,0],[255,193,0],[255,196,0],[255,200,0],[255,204,0],[255,207,0],[255,211,0],[255,215,0],[255,218,0],[255,218,0],[255,222,0],[255,225,0],[255,229,18],[255,233,0],[255,236,0],[255,240,0],[255,244,0],[255,247,0],[255,251,0],[255,255,0],[247,255,0],[239,255,0],[230,255,0],[221,255,0],[212,255,0],[204,255,0],[195,255,0],[186,255,0],[178,255,0],[169,255,0],[160,255,0],[151,255,0],[143,255,0],[134,255,0],[125,255,0],[116,255,0],[108,255,0],[99,255,0],[90,255,0],[82,255,0],[73,255,0],[64,255,0],[55,255,0],[47,255,0],[38,255,0],[29,255,0],[20,255,0],[12,255,0],[3,255,0],[0,255,6],[0,255,14],[0,255,23],[0,255,32],[0,255,41],[0,255,49],[0,255,58],[0,255,67],[0,255,76],[0,255,84],[0,255,93],[0,255,102],[0,255,110],[0,255,119],[0,255,128],[0,255,137],[0,255,145],[0,255,154],[0,255,163],[0,255,172],[0,255,180],[0,255,189],[0,255,198],[0,255,206],[0,255,215],[0,255,224],[0,255,233],[0,255,241],[0,255,250],[0,253,255],[0,250,255],[1,248,255],[1,245,255],[2,242,255],[2,239,255],[3,236,255],[3,233,255],[4,230,255],[4,227,255],[5,224,255],[5,221,255],[6,218,255],[6,216,255],[7,213,255],[7,210,255],[8,207,255],[8,204,255],[9,201,255],[9,198,255],[10,196,255],[11,193,255],[11,190,255],[12,187,255],[12,184,255],[13,181,255],[13,178,255],[14,175,255],[14,172,255],[15,169,255],[15,166,255],[16,163,255],[16,161,255],[17,158,255],[17,155,255],[18,152,255],[18,149,255],[19,146,255],[19,143,255],[20,141,255],[20,138,255],[21,135,255],[21,132,255],[22,129,255],[22,126,255],[23,123,255],[23,120,255],[24,117,255],[24,114,255],[25,111,255],[26,109,255],[29,107,255],[34,105,255],[38,103,255],[42,101,255],[46,99,255],[50,97,255],[54,95,255],[58,93,255],[62,91,255],[67,89,255],[70,87,255],[75,85,255],[78,83,255],[83,81,255],[87,79,255],[91,77,255],[96,75,255],[99,73,255],[104,71,255],[107,70,255],[112,67,255],[115,66,255],[120,64,255],[124,61,255],[128,60,255],[132,58,255],[136,56,255],[140,54,255],[144,52,255],[149,50,255],[153,48,255],[157,46,255],[161,44,255],[165,42,255],[169,40,255],[173,38,255],[177,36,255],[182,34,255],[185,32,255],[190,30,255],[193,29,255],[198,26,255],[202,25,255],[206,23,255],[210,20,255],[214,19,255],[219,17,255],[222,15,255],[227,13,255],[230,11,255],[235,9,255],[239,7,255],[243,5,255],[247,3,255],[251,1,255],[255,0,253],[255,0,240],[255,0,227],[255,0,215],[255,0,202],[255,0,189],[255,0,177],[255,0,164],[255,0,152],[255,0,139],[255,0,126],[255,0,114],[255,0,101],[255,0,88],[255,0,76],[255,0,63],[255,0,51],[255,0,38],[255,0,25],[255,0,13]]
...
function start()
{
    ...
    setTimeout(function()
    {
        activestreams ++
        var id = 2
        var url = encodeGetParams("/db.json",{"x":x+pixelwidth,y,zoom,"size":size/2,id})
        //start requesting
        request(url,1,0,id)
    },1)
    setTimeout(function()
    {
        activestreams ++
        var id = 3
        var url = encodeGetParams("/db.json",{x,"y":y+pixelwidth,zoom,"size":size/2,id})
        //start requesting
        request(url,0,1,id)
    },1)
    setTimeout(function()
...
function request(url,movex,movey,id)
{
    ...
    if(typeof(EventSource) !== "undefined")
    {
        ...
        source[id].onerror = function(event)
        {
            source[id].close()
            activestreams --
            console.log("stream id: "+id+" is not active anymore. The server might have closed it or it is unreachable")
        }
